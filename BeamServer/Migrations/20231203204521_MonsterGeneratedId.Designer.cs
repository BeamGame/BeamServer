...
namespace BeamServer.Migrations
{
    ...
    [Migration("20231203204521_MonsterGeneratedId")]
    partial class MonsterGeneratedId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeamServer.Entities.Monster", b =>
                {
                    b.HasOne("BeamServer.Entities.Beamon", "Beamon")
                        .WithMany("Monsters")
                        .HasForeignKey("BeamonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
